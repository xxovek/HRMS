...
<head>
  ...
  <title>HRM MANAGEMENT | SALARY PAYSLIPS</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <section class="content">
        ...
        <div class="col-md-5" >
        <button type="button" class="btn btn-default"  onClick="javascript:history.go()">Back</button>
        </div>
        </div>
...
$.ajax({
  ...
  success:function(response){
    ...
    +month+","+year+');"><i class="fa fa-download"></i></button><button type="button" title="View Payslip Structure" name="edit" class="label label-primary pull-right" onClick="view_payslip('+ id+','+month +');"><i class="fa fa-eye"></i></button></div></td></tr>');
    }
