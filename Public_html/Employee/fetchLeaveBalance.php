...
$sql1="SELECT NoOfDays from EmployeeLeaveAdditional WHERE EmpId = '$EmpId' AND LeaveId='$l_id'";
$sql2="SELECT SUM(NoOfDays) as sum1 from EmployeeLeaves WHERE EmpId = '$EmpId' AND LeaveId='$l_id'";
